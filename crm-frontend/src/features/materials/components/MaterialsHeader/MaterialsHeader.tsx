...
export const MaterialsHeader = ({ onAdd, search, onSearchChange }: MaterialsHeaderProps) => (
  <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
    <h1 className="text-xl font-semibold text-slate-900 tracking-tight shrink-0">Материалы</h1>
