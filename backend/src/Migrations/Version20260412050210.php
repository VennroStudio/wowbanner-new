 ...
 */
final class Version20260412050210 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client_phones (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, type SMALLINT NOT NULL, phone VARCHAR(50) NOT NULL, INDEX idx_client_id (client_id), INDEX idx_phone (phone), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE clients (id INT AUTO_INCREMENT NOT NULL, old_full_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, middle_name VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, info LONGTEXT DEFAULT NULL, docs SMALLINT NOT NULL, type SMALLINT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX idx_email (email), INDEX idx_last_name (last_name), INDEX idx_type (type), INDEX idx_created_at (created_at), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE client_phones');
